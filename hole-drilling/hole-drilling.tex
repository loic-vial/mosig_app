...
First of all, since we can not prove that the greedy algorithm is a 2-approximation, we chose to look at a different direction and prepare a little bit the problem.
